...
namespace VirtualBrightPlayz.SCPSL.CustomSpawnPositions.Commands
{
    ...
    public class DeleteAllPlayers : ICommand
    {
        public string Command => "CSP_PLAYER_DEL_ALL_YES";

        public string[] Aliases => new string[0];

        public string Description => "Clears ALL player spawns.";
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            if (plugin.Config.csp_auto_save)
                plugin.DatabaseSave();
            response = "Player Spawns cleared.";
            return true;
        }
    }
}
